...
preconditions, thus breaking Lakos rule. There is the related question of wether these
functions should be hardened, but this would be an evolution discussion rather than a defect
